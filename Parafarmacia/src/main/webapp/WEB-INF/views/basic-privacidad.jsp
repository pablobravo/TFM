	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<div class="politicas">
				...
				<p>Titular: Juan</p>
				<p>Domicilio social: Av. Prueba 543 Oviedo España</p>
				<p>CIF: BXXXXXXX</p>
				<p>Registro Público: Inscrita en el Registro Mercantil de
					Oviedo; en el tomo XXXXXX, folio XX, sección X, hoja número
					B-XXXXX, inscripción 1ª</p>
				<p>Puedes contactar con nosotros mediante correo electrónico o
					telefónicamente en el XXXXXXXX, de Lunes a Viernes en horario de
				...
				<p>De conformidad con lo dispuesto en la Ley Orgánica 15/1999,
					...
					propiedad de Parafarmacia Bravo, debidamente inscrito ante la
				...
				<p>Gestionar su registro como usuario en la plataforma online
					www.parafarmaciaonline.hol.es propiedad de Parafarmacia Bravo. No
				...
				<p>En la medida en que www.parafarmaciaonlin.hol.es es una
					...
					serán comunicado por parte de Parafarmacia Bravo al establecimiento
				...
				<p>Transferirlos a otros Estados, sin vuestro consentimiento
					previo.</p>
				<p>Parafarmacia Bravo se reserva el derecho a modificar en
				...
				<p>Siempre que realicemos alguna comunicación de este tipo será
					...
					email a la dirección legal@parafarmaciaonline.com.</p>
				...
				<p>De conformidad con lo dispuesto en la Ley Orgánica 15/1999 de
					...
					solicitándolo por escrito a la Av. Prueba XX España, o a través de
					correo electrónico a la dirección legal@parafarmaciaonline.com,
