		...
		<div class="main">
			...
			<div class="politicas">
				...
				<p>Registro Público: Inscrita en el Registro Mercantil; en el tomo 
					19, folio 2, sección 5, hoja 28
					</p>
				<p>Puedes contactar con nosotros mediante correo electrónico o
					telefónicamente en el 665666944</p>
				...
				<p>De conformidad con lo dispuesto en la Ley Orgánica 15/1999,
					...
					propiedad de BravoFarma, debidamente inscrito ante la
				...
				<p>Gestionar su registro como usuario en la plataforma online
					www.parafarmaciaonline.hol.es propiedad de BravoFarma. No
				...
				<p>En la medida en que BravoFarma es una
					...
					serán comunicado por parte de BravoFarma al establecimiento
				...
				<p>Transferirlos a otros Estados, sin vuestro consentimiento
					previo.</p>
				<p>BravoFarma se reserva el derecho a modificar en
				...
				<p>Siempre que realicemos alguna comunicación de este tipo será
					...
					email a la dirección pablo@gmail.com.</p>
				...
				<p>De conformidad con lo dispuesto en la Ley Orgánica 15/1999 de
					...
					solicitándolo por escrito a la calle estación, Colloto, España, o a través de
					correo electrónico a la dirección pablo@gmail.com,
