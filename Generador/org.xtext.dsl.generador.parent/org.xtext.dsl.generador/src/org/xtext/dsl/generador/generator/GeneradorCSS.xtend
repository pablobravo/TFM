...
class GeneradorCSS {
	...
	def compilarTexto(Parafarmacia p) '''		
		...
		@media (min-width: 935px) {
			...
			:root { 
			/* Colores */
			--main-color: «p.apariencia.principal»; 
			--main-color-claro: «p.apariencia.principalClaro»; 
			--second-color: «p.apariencia.secundario»;
			«IF p.tipo.permanente !== null»
				--nav-color:«p.tipo.permanente.color»; 
			«ELSE»
				--nav-color:«p.tipo.desplegable.color»; 
			«ENDIF»
			...
			/* Tamaños elementos */
			--margenes-laterales: «p.apariencia.lateral»;
			«IF p.tipo.permanente !== null»
				--altura-menu: «p.tipo.getPermanente().altura»;
			«ELSE»
				--altura-menu: 40px;
			«ENDIF»
			
			«IF p.numProductosPorFila == 2»
				--ancho-productos:calc(50% - 50px);
			«ELSEIF p.numProductosPorFila == 3»
				--ancho-productos:calc(33% - 50px);
			«ELSEIF p.numProductosPorFila == 4»
				--ancho-productos:calc(25% - 50px);
			«ELSEIF p.numProductosPorFila == 5»
				--ancho-productos:calc(20% - 50px);
			«ELSE»
				--ancho-productos:calc(16.6% - 50px);
			«ENDIF»
			
			
			/* Tamaños textos */
			--size-texto: «p.apariencia.normal»;
			--size-texto-grande:«p.apariencia.grande»;
			--size-menu:«p.apariencia.menu»;
			--size-titulo:«p.apariencia.titulo»;
