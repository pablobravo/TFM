...
import org.xtext.dsl.parafarmacia.web.ParafarmaciaWebSetup;
...
public class ParafarmaciaServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new ParafarmaciaWebSetup().createInjectorAndDoEMFRegistration();
